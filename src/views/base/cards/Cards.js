        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-medium-emphasis small">
              ...
              {' '}
              <code>&lt;CCardTitle&gt;</code>
              {' '}
              component. Identically,
              links are attached and collected next to each other by
              {' '}
              <code>&lt;CCardLink&gt;</code>
              {' '}
              component.
